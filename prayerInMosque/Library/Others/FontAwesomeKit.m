...
//				   alignment:NSTextAlignmentCenter]; Ahmad Changed
        
        NSDictionary *attributes = @{ NSFontAttributeName: iconFont,
                                      NSParagraphStyleAttributeName: paragraphStyle };
        [iconChar drawInRect:iconRect withAttributes:attributes];
		
	} else {
        NSDictionary *attributes = @{ NSFontAttributeName: iconFont };
		//[iconChar drawInRect:iconRect withFont:iconFont]; Ahmad Changed
