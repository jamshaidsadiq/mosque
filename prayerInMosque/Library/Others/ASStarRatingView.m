...
- (void)baseInit {
    _notSelectedStar = [[UIImage imageNamed:@"unSelectedStar"] retain];
    _selectedStar = [[UIImage imageNamed:@"selectedStar"] retain];
    _halfSelectedStar = [[UIImage imageNamed:@"halfStarSelected"] retain];
    if (self.listRating==YES) {
        _notSelectedStar = [[UIImage imageNamed:@"mapListUnselectedStar"] retain];
        _selectedStar = [[UIImage imageNamed:@"mapListSelectedStar"] retain];
        _halfSelectedStar = [[UIImage imageNamed:@"mapListHalfSelectedStar"] retain];
    }
